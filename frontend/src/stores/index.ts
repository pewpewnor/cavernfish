...
export const activePage = writable<Page>("workspace");

export type WorkspaceTab = "collections" | "servers" | "breakpoints";
export const activeWorkspaceTab = writable<WorkspaceTab>("collections");

export const workspaceSidebarWidthRem = writable<number>(15);
